...
const Navbar = () => {
    ...
    return (
        <div>
            <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-gradient-to-br from-[#C8AF9C] to-[#a34610] shadow-lg' : 'bg-gradient-to-br from-[#C8AF9C] to-[#a34610]'}`}>
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden bg-white border-t">
                        <div className="px-4 py-3 space-y-3">
                            <a href="#" className="block text-white hover:text-violet-600 transition font-medium">Home</a>
                            <a href="#" className="block text-white hover:text-violet-600 transition font-medium">Shop</a>
                            <a href="#" className="block text-white hover:text-violet-600 transition font-medium">Categories</a>
                            <a href="#" className="block text-white hover:text-violet-600 transition font-medium">About</a>
                            <a href="#" className="block text-white hover:text-violet-600 transition font-medium">Contact</a>
                        </div>
                    </div>
                )}
            </nav>
