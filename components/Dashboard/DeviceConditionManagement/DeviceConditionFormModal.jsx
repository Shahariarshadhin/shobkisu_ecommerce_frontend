...
const DeviceConditionFormModal = ({ isOpen, editingCondition, onClose, onSubmit, loading }) => {
  ...
  useEffect(() => {
    if (editingCondition) {
      ...
      setFormData({ condition: '', description: '', isActive: true });
    }
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all duration-300 scale-100">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-gray-800">
            {editingCondition ? 'Edit Device Condition' : 'Add New Device Condition'}
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200"
              placeholder="e.g., Brand New, Excellent, Good, Fair"
            />
          </div>
...
export default DeviceConditionFormModal;